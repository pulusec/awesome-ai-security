...
* [Kata Containers](https://kata-containers.github.io/kata-containers/) - _Open-source container runtime building lightweight VMs to provide the workload isolation and security advantages of VMs while preserving container speed and resource efficiency. CNCF project._
* [agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) - _Kubernetes SIG project providing a `Sandbox` CRD and controller for running AI agent code in isolated, secure environments on Kubernetes._
